...
class _DislikedPageState extends State<DislikedPage> {
  ...
  Future<void> _loadDisliked() async {
    ...
    try {
      final data = await _api.getDisliked(email: email);
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(_error ?? "Failed to load disliked")),
      );
    }
  }

  Future<void> _removeFromDisliked(String restaurantId) async {
    final email = Session.email.trim();
    if (email.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
    ...
    try {
      ...
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Removed from disliked ✅")),
      );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: _loadDisliked,
            icon: const Icon(Icons.refresh, color: Colors.black),
          ),
        ],
      ),
      body: RefreshIndicator(
        onRefresh: _loadDisliked,
        child: ListView(
          ...
          children: [
            ...
            if (_loading)
              ...
              Padding(
                ...
                child: Center(
                  child: Text(
                    "No items in your disliked list",
